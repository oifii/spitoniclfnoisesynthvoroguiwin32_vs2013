...
#include "stdafx.h"
#include "spitoniclfnoisesynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitoniclfnoisesynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitoniclfnoisesynthvoroguiwin32class"};				// the main window class name
